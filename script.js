function calculate() {
  ...
  if (
    ...
    document.getElementById("answer4").value = "Not Applicable (N/A)";
  } else if (
    ...
    document.getElementById("answer1").value =
      ...
      "Primer - Epilux 13 HB Primer \nIntermediate - Not Applicable (N/A) \nFinish Coat - Epilux STL Ctg";
    ...
    ddocument.getElementById("answer4").value =
    "Primer - Protectomastic \nIntermediate - Epilux 4 HB MIO \nFinish Coat - Bergerthane PU Glossy Finish";
    ...
    document.getElementById("answer1").value =
      "Primer - Red Oxide Zinc Phosphate Primer \nIntermediate - Not Applicable (N/A) \nFinish Coat - Aluminium Finish Paint, two coats each of DFT 15-20 micron";
      document.getElementById("answer4").value =
            "Primer - BR ROZP Primer \nIntermediate - Not Applicable (N/A) \nFinish Coat - BR Aluminium 2339";
